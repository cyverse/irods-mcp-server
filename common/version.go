...
// GetServerVersion returns client version in string
func GetServerVersion() string {
	return serverVersion
}

// GetServerVersionWithoutV returns client version in string
func GetServerVersionWithoutV() string {
	return strings.TrimLeft(serverVersion, "v")
}
